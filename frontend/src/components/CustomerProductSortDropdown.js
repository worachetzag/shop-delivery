 ...
 * @param {string} [className] — เพิ่มที่ wrap เช่น customer-sort-dropdown-wrap--compact
 */
function CustomerProductSortDropdown({ options, value, onChange, labelText = 'เรียงตาม', className = '' }) {
  ...
  return (
    <div className={`customer-sort-dropdown-wrap filter-group ${className}`.trim()}>
      ...
      <div className="customer-sort-dropdown" ref={rootRef}>
        <button
          type="button"
          className="customer-sort-trigger"
