...
urlpatterns = [
    ...
    path('home-promotions/', views.HomePromotionListView.as_view(), name='home-promotion-list'),
    path('admin/home-promotions/', views.AdminHomePromotionListCreateView.as_view(), name='admin-home-promotion-list-create'),
    path('admin/home-promotions/<int:pk>/', views.AdminHomePromotionDetailView.as_view(), name='admin-home-promotion-detail'),
